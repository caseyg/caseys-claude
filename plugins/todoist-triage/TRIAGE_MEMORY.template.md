...
**Setup:** Copy this template to `data/TRIAGE_MEMORY.md` before your first triage session. The skill will update that file with your personal patterns and preferences.
...
_Run the triage skill to start your first session._
...
### Project IDs
_Your project IDs will be populated after the first sync._

### Workflow Notes
_Personal workflow preferences will be learned over time._
